...
// WARNING : this file shall not be compiled directly : it is included in vars_names.c !!!
...
StrConvIdVarName TableConvIdVarName[] = {
...
#endif
		{ "C%d.Q", VAR_COUNTER_DONE, 0, /*sizes*/ NBR_COUNTERS_DEF, -1, -1, /*offsets */ 0, 0, 0, FALSE, "Counter xx done" },
		...
		{ "X%d.X", VAR_STEP_ACTIVITY, 0, /*sizes*/ NBR_STEPS, -1, -1, /*offsets */ 0, 0, 0, FALSE, "Activity of step xx" },
